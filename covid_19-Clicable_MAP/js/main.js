                        ...
                        onClick: function(event) {
                            ...
                            editor.panel.show(new Element("div", {}).adopt(
                                ...
                                new Element("input", {
                                    ...
                                    state.link = validURL($$("#editor .panel .content input")[1].get("value"));
                                    editor.render();
                                }),
                                ...
                                new Element("textarea", {
                                    ...
                                    state.popupcontent = $$("#editor .panel .content textarea")[0].get("value");
                                    editor.render();
                                }),
                                ...
                                new Element("input", {
                                    ...
                                    state.cssclass = $$("#editor .panel .content input")[4].get("value");
                                    editor.render();
                                }),
                        ...
                        onClick: function(event) {
                            ...
                            editor.panel.show(new Element("div", {}).adopt(
                                ...
                                new Element("input", {
                                    ...
                                    state.cssclass = $$("#editor .panel .cssclass input")[4].get("value");
                                    editor.render();
                                }),
...
$$("#editor .options .font .fontsize").addEvent("change", function(event) {
    data.options.fontsize = this.get("value");
    if (event)
        editor.render();
}).fireEvent("change");

$$("#editor .options .font select.font").addEvent("change", function(event) {
...
$$("#editor .options .show-link-titles select").addEvent("change", function(event) {
